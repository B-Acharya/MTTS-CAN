...
def plot_signals(pulse_pred, pulse_truth, save_path, dataset, model_name):
	...
	if dataset == "VIPL":
		directory = pathlib.Path("/home/bhargav/MTTS-CAN/code/Predictions/vipl/" + model_name + "/")
...
if __name__ == "__main__":
	if database_name == "PURE":
		...
		model_checkpoint = "/home/bacharya/PURE/checkpoints/normalized-PURE-Hybrid_CAN-4-19/cv_0_epoch02_model.tf"
		...
		model_checkpoints = [
			("Hybrid_CAN", "/home/bhargav/vipl/checkpoints/short-VIPL-Hybrid_CAN-4-39/cv_0_epoch01_model.tf/"),
			("TS_CAN", "/home/bhargav/vipl/checkpoints/short-VIPL-TS_CAN-4-32/cv_0_epoch01_model.tf/"),
			("CAN_3D", "/home/bhargav/vipl/checkpoints/short-VIPL-CAN_3D-4-39/cv_0_epoch01_model.tf/")]
	...
	for model_name, model_checkpoint in model_checkpoints:
		...
		predict_vitals(worksheet, test_name, model_name, path_of_video_test, path_results, model_checkpoint,
					   database_name)

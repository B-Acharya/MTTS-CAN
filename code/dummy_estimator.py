...
def evaluate(path_of_video, dummyEst,dummyBVP, dataset):
    ...
    for video_path in path_of_video:
        ...
        pulse_truth = np.array(gound_truth_file['pulse'])
        gound_truth_file.close()
...
if __name__ == "__main__":
    ...
    if dataset == "PURE":
        ...
        logging.info('Started')
        dataset = "/home/bhargav/cohface/"
        split_path = "/home/bhargav/cohface/protocols/all/"
    ...
    errors_HR, errors_bvp = evaluate(path_of_video_dev,dummy_mean, bvp_mean, dataset)
    logging.info(f"******************************************************")
